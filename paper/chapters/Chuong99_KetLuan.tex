...
%    - Phụ lục (qua \input{front/pages/PhuLuc})
%
...
\begin{itemize}[leftmargin=2em]
  \item Thu thập thêm dữ liệu đa dạng về thể loại và chủ đề tin giả tiếng Việt, đặc biệt là các dạng nội dung mới phát sinh.
  \item Tích hợp thông tin đa phương thức (hình ảnh, đồ thị lan truyền trên mạng xã hội) để bổ trợ cho tín hiệu văn bản.
  \item Xây dựng hệ thống phát hiện thời gian thực với phiên bản PhoBERT đã được nén nhỏ thông qua knowledge distillation.
  \item Kết hợp kiểm chứng thực tế (fact-checking) với phân loại tự động để tăng độ tin cậy tổng thể.
\end{itemize}
