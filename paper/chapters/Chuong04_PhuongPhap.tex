...
Trong thời gian gần đây, bài toán phát hiện tin giả bằng tiếng Việt ngày càng được quan tâm trong lĩnh vực xử lý ngôn ngữ tự nhiên. Sự mở rộng của các nền tảng trực tuyến khiến lượng thông tin được tạo ra và chia sẻ ngày càng lớn, nhưng đồng thời cũng làm gia tăng khả năng lan truyền của những nội dung thiếu chính xác. Điều này có thể dẫn đến nhiều ảnh hưởng tiêu cực đối với cộng đồng và xã hội. Vì vậy, việc nghiên cứu các phương pháp tự động để nhận diện thông tin sai lệch có ý nghĩa thiết thực cả về phương diện nghiên cứu lẫn ứng dụng.

Trong quy trình xử lý văn bản, nội dung ban đầu thường được chuyển sang dạng biểu diễn số để các mô hình học máy có thể tiếp nhận. Các kỹ thuật như bag-of-words, TF-IDF và word embedding tạo ra những dạng biểu diễn khác nhau cho dữ liệu văn bản. Sự phát triển của các phương pháp học sâu cho phép mô hình khai thác trực tiếp nhiều đặc điểm ngữ cảnh trong nội dung đầu vào. Đặc biệt, các kiến trúc thuộc họ Transformer cùng những mô hình ngôn ngữ dựa trên chúng đã trở thành lựa chọn phổ biến cho nhiều nhiệm vụ xử lý và phân loại văn bản, nhờ khả năng học các đặc trưng ngữ nghĩa từ dữ liệu.
...
Đối với nhiệm vụ phân loại văn bản, đặc biệt trong bài toán phát hiện tin giả, việc đánh giá các phương pháp có thể dựa trên ba tiêu chí chính:
\begin{itemize}
