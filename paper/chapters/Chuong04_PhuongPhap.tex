...
Trong những năm gần đây, việc nhận diện tin giả trên các văn bản tiếng Việt trở thành một chủ đề đáng chú ý trong lĩnh vực xử lý ngôn ngữ tự nhiên. Sự phát triển nhanh của các nền tảng trực tuyến làm gia tăng đáng kể lượng thông tin được chia sẻ, đồng thời cũng tạo điều kiện cho nội dung thiếu chính xác lan truyền rộng rãi và gây ra nhiều hệ quả tiêu cực đối với xã hội. Do đó, việc xây dựng các phương pháp tự động nhằm xác định nội dung sai lệch có vai trò quan trọng cả trong nghiên cứu và trong các ứng dụng thực tế.

Để xử lý một văn bản, bước đầu tiên thường là chuyển nội dung dạng chữ thành biểu diễn số để mô hình có thể tiếp nhận và học hỏi. Các phương pháp như bag-of-words, TF-IDF và word embedding thực hiện quá trình này theo những cách khác nhau, qua đó tạo ra các dạng biểu diễn phù hợp cho dữ liệu văn bản. Cùng với sự phát triển của học sâu, các mô hình có khả năng khai thác trực tiếp thông tin ngữ cảnh trong câu ngày càng được quan tâm. Đặc biệt, Transformer và những mô hình ngôn ngữ dựa trên kiến trúc này đã được ứng dụng rộng rãi trong nhiều nhiệm vụ xử lý và phân loại văn bản, nhờ khả năng nắm bắt hiệu quả các đặc điểm ngữ nghĩa của dữ liệu.
